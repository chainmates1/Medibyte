...
/// @title - A simple messenger contract for transferring tokens to a receiver  that calls a Health contract.
contract Sender is OwnerIsCreator {
    ...
    event MessageSent(
        ...
        address patient,//The address of the patient 
        uint8[] selectedTests,//Tests selected by the patient
        ...
        returns (bytes32 messageId)
    {
        ...
        Client.EVM2AnyMessage memory evm2AnyMessage = Client.EVM2AnyMessage({
            ...
            data: abi.encodeWithSelector(
                IHealth_Contract.selectTests.selector,
                _patient,
                _selectedTests,
                _amount
            ), // Encode the function selector and the arguments of the selectTests function
